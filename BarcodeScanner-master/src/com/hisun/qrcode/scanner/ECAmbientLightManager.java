 ...
 */
final class ECAmbientLightManager implements SensorEventListener {

	private static final float TOO_DARK_LUX = 45.0f;
	private static final float BRIGHT_ENOUGH_LUX = 450.0f;
	private static final String TAG = "ECAmbientLightManager";
	...
	ECAmbientLightManager(Context context) {
	...
	void start(CameraManager cameraManager) {
		...
		if (ECQrCodeManager.getInstance(context).getLightMode() == FrontLightMode.AUTO) {
			Log.e(TAG, "开启");
