 ...
 */
final class ECDecodeThread extends Thread {
	...
	ECDecodeThread(Context activity, Collection<BarcodeFormat> decodeFormats,
	...
	public void run() {
		Looper.prepare();
		handler = new ECDecodeHandler(activity, hints);
